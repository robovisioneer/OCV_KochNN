...
<p align="left">
Um das rekursive Programmieren zu erlernen, setzen sich Informatik-Studenten mit der Koch-Kurve auseinander. Warum eine Funktion die noch nicht einmal stückweise glatt ist als "Kurve" bezeichnet wird, wird mir immer ein Rätsel bleiben...</p>
<p align="left">
...
<p align="left">
Das Programm besteht aus zwei neuronalen Netzen, die in diesem Text mit den Funktionen <cite>f</cite> und <cite>g</cite> beschrieben werden. Die eine Funktion / das erste neuronale Netz <cite>s = f(x)</cite> ordnet jedem x-Wert eine zurueckgelegte Strecke 's' zu; die andere Funktion / das zweite neuronale Netz y = g(s) ordnet jeder zurueckgelegten Strecke einen y-Wert zu.
</p>

<p align="left">
Da sich die Koch-Kurve aus linearen Werten zusammensetzt wurde das Leaky-ReLU-Neuronen-Modell gegenüber Neuronen-Modellen mit Sigmoid-Funktionen arbeiten favorisiert.
</p>
